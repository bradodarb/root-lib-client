...
var app_documentTypeEditor = new SW.app.Application({

    appName: "documentTypeManager"

	, initV: function () {
	    var vp1 = new SW.v.ViewProvider({ viewContext: "default" });
	    vp1.register("DocumentType", "documentTypeStructure");
	    this.V.register(vp1);
	}
	, initVM: function () {
	    var vm = new SW.documentTypeEditor();
	    this.VM.register("documentTypeEditor", vm);
	    this.setRootVM(vm);


	    var href = window.location.href;
	    var id = href.substr(href.lastIndexOf('/') + 1)
	    vm.getDocumentType(id);
	}

});

///Register Applications
SW.sess.register(app_documentTypeEditor);
